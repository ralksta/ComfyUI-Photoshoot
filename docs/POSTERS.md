...
## Tops Matrix (12 Crop Tops)

The twelve tops of the Clothing tab on the person from the README — the same
Person Builder state, loft scene, softbox light and Kodak Portra style, photo 1 of
the series (seed 0), waist up. Only the top and its colour change; pose and
expression are held fixed. Every wording passed a render test against a bare
"crop top" before it went in; the poster shows the exact wording the node writes.

[![Photoshoot Tops Matrix](posters/photoshoot_tops_matrix_12_web.jpg)](posters/photoshoot_tops_matrix_12.png)
*(Click image to open full-resolution 2360×2931 master poster)*
...
## Bottoms Matrix (29 Skirts, Shorts & Trousers)

All 29 bottoms, full body, on the same person and settings as the tops, with a
white crop top and her black combat boots throughout. The colour goes in front of
...
[![Photoshoot Bottoms Matrix](posters/photoshoot_bottoms_matrix_29_web.jpg)](posters/photoshoot_bottoms_matrix_29.png)
*(Click image to open full-resolution 3528×4709 master poster)*

| Family | Presets |
|---|---|
| **Skirts** | *Mini, Pencil, Pleated Mini, Pleated Midi, Slit Maxi, Wrap Mini, Micro Mini, Skater, Front-Slit Pencil, Double-Slit Maxi, High-Low, Bias-Cut Midi, Short Tulle, Corset, Fringe (Latin), Tennis, Skort* |
