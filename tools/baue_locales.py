...
BESCHREIBUNG = {
    ...
    "Krea2PromptJoin": (
        ...
        "{lighting} {scene} {style} {extra}. Recommended: {style}, {camera}, {scene}, "
        "{lighting}, {person}, {pose}, {extra}, {expression}. The German spellings still "
        "work. {extra} is for extension packs. Without placeholders: style first, then "
        "camera, scene and lighting before the person."),
