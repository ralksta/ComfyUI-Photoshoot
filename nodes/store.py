...
class Krea2PromptJoin:
    ...
    DESCRIPTION = ("Ersetzt {person1} {person2} {person3} {kamera} {pose} {ausdruck} "
                   "{licht} {szene} {stil} {extra}. Empfohlen: {stil}, {kamera}, {szene}, "
                   "{licht}, {person}, {pose}, {extra}, {ausdruck}. {extra} optional für "
                   "Erweiterungs-Packs. Ohne Platzhalter: Stil zuerst, dann Kamera/Szene/"
                   "Licht vor Person.")
    ...
    def join(self, text, person_1="", person_2="", person_3="", kamera="",
        ...
        if any("{%s}" % p in basis for p in PLATZHALTER):
            ...
            # No placeholder: style first, then framing, room and lighting
            # before the person. The style used to go last, and there a
            # colour treatment did not take: "black and white photograph" at
            # the end of the prompt still came out in colour, at the front it
            # came out monochrome, with the wide shot as wide as before
            # (docs/measurements.md).
            vorn = [werte[p] for p in ("stil", "kamera", "szene", "licht",
