...
# Families of the tops - one so far; skirts, blouses and the rest follow as
# families of their own once their wordings have passed the same render test.
OBERTEIL_GRUPPEN = {
    "Crop Tops": [l for l, _ in PRESETS["top"]],
}

UNTERTEIL_GRUPPEN = {
    "Röcke": [l for l, _ in PRESETS["bottom"][:6] + PRESETS["bottom"][12:23]],
    "Shorts & Hosen": [l for l, _ in PRESETS["bottom"][6:12] + PRESETS["bottom"][23:]],
}
...
SEKTIONEN = [
    ...
    ("Kleidung", [["top", "topColor"], ["bottom", "bottomColor"], "bottomMaterial", ["hosiery", "hosieryColor"], ["shoes", "shoesColor"],
