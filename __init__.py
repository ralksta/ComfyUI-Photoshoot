...
from .nodes import (api, expression_builder, lighting_builder, mono, person_builder,
                    pose_builder, shooting, store, style_builder, wardrobe)
...
for _modul in (person_builder, expression_builder, pose_builder,
               lighting_builder, style_builder, mono, shooting, store, wardrobe):
