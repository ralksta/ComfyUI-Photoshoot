...
function pool(d, quelle, cat, state, kamera, haltung) {
  ...
  // Body tension against the base posture, same reasoning.
  if (cat === "spannung" && haltung && d.haltungSpannung?.[haltung]) {
    const erlaubt = d.haltungSpannung[haltung];
